...
export function activeWindowSync() {
	try {
		...
		const stdout = childProcess.execFileSync(xpropBinary, [...xpropDetailsArguments, activeWindowId], {encoding: 'utf8'});
		const boundsStdout = childProcess.execFileSync(xwininfoBinary, [...xpropDetailsArguments, activeWindowId], {encoding: 'utf8'});
